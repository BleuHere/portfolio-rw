    ...
    <>
      ...
      <div className="content">
        <p>
          ...
          <em> &apos;holy moly, this is great!&apos;.</em> It became clear that
          I did indeed have a knack for (and love of) logic and problem solving.
        </p>
        <p>
        ...
        <p>
          My stack is built on Node.js, React, Redux and Express. My testing
          suite includes TestingLibrary, Jest and Supertest. I&apos;m working on
          some cool personal and group projects at the moment. Head to the
          Projects page for more info on those.
        </p>
      </div>
    </>
  )
